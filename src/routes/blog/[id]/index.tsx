...
const usePost = routeLoader$(async (loaderEvent) => {
  const response = await fetch(
    `https://interb-be-production.up.railway.app/post/get/id/${loaderEvent.params["id"]}`,
    { method: "GET" }
  );
...
export default component$(() => {
  ...
  const commentSection = useResource$(async ({ track }) => {
    ...
    const response = await fetch(
      `https://interb-be-production.up.railway.app/comment/get/${loc.params["id"]}`,
      { method: "GET" }
    );
    const body = await response.json();
                              ...
                              <button
                                onClick$={async () => {
                                  if (
                                    ...
                                    await fetch(
                                      `https://interb-be-production.up.railway.app/comment/${comment.id}`,
                                      {
                                        method: "DELETE",
                                        credentials: "include",
                                      }
              ...
              <div>
                ...
                <button
                  onClick$={async () => {
                    ...
                    try {
                      await fetch("https://interb-be-production.up.railway.app/comment", {
                        method: "POST",
                        credentials: "include",
